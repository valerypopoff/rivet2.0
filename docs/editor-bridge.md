...
|---|---|---|
| `open-project` | `path`, `replaceCurrent`, optional `preview`, optional `reloadFromDisk` | User opens or creates a workflow project |
