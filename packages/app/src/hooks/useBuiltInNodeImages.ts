...
export const useBuiltInNodeImages = (): Partial<Record<BuiltInNodeType, string>> => {
  return {
    ...
    getStoredValue: getGlobalNodeImage,
    ...
    setStoredValue: setGlobalNodeImage,
    ...
    knowledgeSource: libraryNode,
    knowledgeDocument: documentNodeImage,
    syncKnowledgeSource: vectorStoreNodeImage,
    getKnowledgeSourceStatus: vectorKnnNodeImage,
    searchKnowledge: vectorKnnNodeImage,
    buildKnowledgeContext: assemblePromptNodeImage,
