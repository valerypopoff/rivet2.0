...
export const BUILT_IN_NODE_DOCUMENTATION_SLUGS: Partial<Record<BuiltInNodeType, string>> = {
  ...
  chatLoop: 'chat-loop',
  chunk: 'chunk',
  classifierEvaluate: 'classifier-evaluate',
  classifierQuestion: 'classifier-question',
  code: 'code',
  codeNew: 'code-new',
  coalesce: 'coalesce',
  coalesceNew: 'coalesce-new',
  comment: 'comment',
  compare: 'compare',
  context: 'context',
  ...
  getStoredValue: 'get-stored-value',
  ...
  syncKnowledgeSource: 'sync-knowledge-source',
  getKnowledgeSourceStatus: 'get-knowledge-source-status',
  searchKnowledge: 'search-knowledge',
  buildKnowledgeContext: 'build-knowledge-context',
  jsFilter: 'js-filter',
  jsMap: 'js-map',
  ...
  setStoredValue: 'set-stored-value',
  shuffle: 'shuffle',
  slice: 'slice',
  split: 'split-text',
  startBackgroundBranch: 'start-async-branch',
  stopWatchingStreamingOutput: 'stop-watching-streaming-output',
  streamValue: 'stream-value',
  catchStreamingChunks: 'catch-streaming-chunks',
  subGraph: 'subgraph',
  text: 'text',
  toBase64: 'to-base64',
  toJson: 'to-json',
  ...
  watchStreamingOutput: 'watch-streaming-output',
