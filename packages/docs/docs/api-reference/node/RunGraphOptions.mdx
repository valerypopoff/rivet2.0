...
For LLM keys, new programmatic code should use `openAiApiKey`, `anthropicApiKey`, `googleApiKey`, and `customAiApiKey`. The older `openAiKey` option remains supported as an alias for `openAiApiKey`.
