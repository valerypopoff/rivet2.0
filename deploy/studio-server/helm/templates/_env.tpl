...
{{- $root := . -}}
{{- range $key := list "RIVET_PUBLISHED_WORKFLOWS_BASE_PATH" "RIVET_LATEST_WORKFLOWS_BASE_PATH" "RIVET_PUBLISHED_APPS_BASE_PATH" "RIVET_LATEST_APPS_BASE_PATH" "RIVET_WEB_APPS_BASE_PATH" "RIVET_LATEST_WEB_APPS_BASE_PATH" "RIVET_PROXY_RESOLVER" "RIVET_TRUST_INCOMING_FORWARDED_HEADERS" "RIVET_TRUSTED_FORWARDING_PROXIES" }}
