...
`updateProjectMetadata`, `replaceCurrent`, `markCurrentProjectClean`, and
`markProjectClean` so wrapper shells can coordinate their own project list or
file model without reaching into Jotai atoms. `updateProjectMetadata` is the
