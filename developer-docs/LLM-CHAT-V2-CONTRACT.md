...
node type is `llmChatV2`; legacy `Chat` / `Chat Loop (legacy)` nodes remain compatibility
...
| Legacy Chat compatibility boundary                                                                                                      | `ChatNodeBase.ts`, `ChatNode.ts`, `ChatLoopNode.ts`                                                                                                                                   | legacy node tests and compile checks                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | compatibility-only; preserve persisted `chatLoop` type while changing labels only            |
